> **RETIRED 2026-07-16.** The approve-then-/loop flow is replaced by the Content Studio board in Notion plus /content-run. Nothing below should run. Kept for history.
