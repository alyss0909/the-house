---
name: "source-command-execute-lead-magnets"
...
# source-command-execute-lead-magnets

Use this skill when the user asks to run the migrated source command `execute-lead-magnets`.
