...
## The Carousel Spine (every carousel, the skeleton)
EVERY deck does these seven jobs, in this order, whatever the framework. This is the invariant. If a framework's own sequence skips one (How To, for instance, has no explicit proof beat), you STILL owe the spine that job.
...
2. **Second hook:** a reason to keep going, credibility, stakes, a false belief, a hidden opportunity, product philosophy, or one receipt. No teaching yet.
