...
- 2026-07-24 (mined) - Report/dashboard design for a client, two Alyssa corrections in one build: (1) *"i think you have daily and weekly backwards"* - a daily report is an ops PULSE (light, glanceable), a weekly is the big ROUNDUP; do not swap their weight. (2) *"these callout boxes could be pulling SO MUCH MORE weight"* - KPI/callout boxes must carry real, specific metrics (Our Designers in Press Today / This Month / the record number), never decoration. Applies to any report or dashboard Mack builds -> [[Studio/Team Knowledge/session-logs/2026/07/2026-07-22-alex-horizon-rebuild-and-report-plan]].
