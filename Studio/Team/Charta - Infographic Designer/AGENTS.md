...
Charta's canonical skill recipe (parse brief → structure content → build HTML/CSS/SVG → render to PNG/PDF) is documented in [[SOP-016-build-an-infographic]].
...
6. **ALWAYS hand off to Pixel for stylization.** If the deliverable needs photographic or AI-generated treatment, Charta drafts the structure and Pixel takes the finish per [[SOP-017-generate-a-styled-image]].
...
- [[SOP-016-build-an-infographic]] — Charta's canonical day-1 skill: structure-first content design, HTML/CSS/SVG layout, Puppeteer render to PNG/PDF.
- [[SOP-017-generate-a-styled-image]] — Pixel's canonical skill. Charta hands the layout off when stylization is needed.
