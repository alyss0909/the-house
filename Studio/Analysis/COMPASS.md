...
| Opt-in / landing page | 2 | [[Studio/Analysis/sales-page]] (Opening Hook + Hero Headline sections only) |
...
| [[Studio/Analysis/soft-sunday]] | SS-specific dos/don'ts, formatting rules, CTA logic. Always load before any Soft Sunday. | Non-SS tasks |
...
Open [[Studio/Analysis/copy-task-routing]]. It has the full routing rationale, decision notes, gap tracking, and red-flag diagnostic for every task type.
