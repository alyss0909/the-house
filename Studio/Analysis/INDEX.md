...
**Before writing a sales page:** Read `sales-page.md` for the structural map and CTA catalog. Then read the actual BOH sales page in `Library/Examples/sales-pages/`.
