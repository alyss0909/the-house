...
| GL-013 | [[GL-014-the-compounding-architecture]] — the compounding laws: forced consumers, journal core (LOCKED boundary), precedent before invention, reactions become memory, sessions end compounded. Trigger word: **compound**. (Blessed 2026-07-11.)
