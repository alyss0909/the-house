...
- 2026-06-02 (larry) - listener never started; Windows sandbox refresh error blocked the run. Handoff note at `Team Knowledge/session-logs/2026/06/2026-06-02-17-20_larry_telegram-capture-mvp-handoff.md`. Blocker: need to run the Python script and verify test message lands in Team Inbox, then regenerate token.
