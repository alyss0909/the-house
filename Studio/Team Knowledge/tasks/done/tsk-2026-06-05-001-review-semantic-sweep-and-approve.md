...
- Closed 2026-07-16: superseded by behavior. Alyssa ruled the signals layer must run on its own; the sweep is now a permanent step of the Sunday housekeeping patrol and the catch-up sweep ran 2026-07-16. Her open react on the ai-workflow-collecting thesis stands in the garden note.
