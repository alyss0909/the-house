...
- Cancelled 2026-07-16: superseded. The house built its own TelegramCaptureBot, which has been running for weeks; researching the third-party claude-telegram-bot no longer serves anything.
