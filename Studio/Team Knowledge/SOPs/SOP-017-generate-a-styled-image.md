...
- Does not lay out structural visual content (tables, grids, diagrams). That is [[SOP-016-build-an-infographic]] (Charta's skill). When a deliverable needs structure first, run [[SOP-016-build-an-infographic]] first, then this SOP for the finish.
- Does not author the design system. That is [[SOP-014-author-a-design-system]] (Iris's skill).
