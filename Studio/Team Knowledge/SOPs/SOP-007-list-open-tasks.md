...
- **References:** [[SOP-008-rebuild-task-index]]
...
For each task picked up, also read the task's `linked_journal_entries` — see [[SOP-010-read-own-journal]] for the discipline.

## Common mistakes

- Trusting the index when something just changed in the same session. Re-run [[SOP-008-rebuild-task-index]] if you've been editing.
