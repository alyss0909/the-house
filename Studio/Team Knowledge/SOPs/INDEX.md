...
| SOP-033 | [[SOP-033-run-trend-scout-brief]] | — | RETIRED 2026-07-16 with WS-011. Trend input now comes from Alyssa's own saves via /saves-sweep plus the monthly trusted-account scrape. |
| SOP-034 | [[SOP-034-write-concept-pitch-brief]] | — | RETIRED 2026-07-16 with WS-011. Concept work now happens inside /saves-sweep and /content-run under [[Studio/Content/METHOD]]. |
| SOP-035 | [[SOP-035-run-hook-bench]] | — | RETIRED 2026-07-16 with WS-011. Hooks are written inside /content-run per [[Studio/Analysis/carousel-hook-forensics]]. |
| SOP-036 | [[SOP-036-build-substance-dossier]] | — | RETIRED 2026-07-16 with WS-011. Substance and persuasion live in METHOD's buyer-psychology section, applied per post in /content-run. |
