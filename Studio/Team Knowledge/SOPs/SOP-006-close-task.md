...
- **References:** [[SOP-008-rebuild-task-index]], [[SOP-009-write-journal-entry]]
...
6. **If you learned something durable, write a journal entry.** See [[SOP-009-write-journal-entry]]. Link it from the `## Outcome` section, and add the entry's basename to `linked_journal_entries:` in this task's frontmatter (so future readers of this task get the lesson).
