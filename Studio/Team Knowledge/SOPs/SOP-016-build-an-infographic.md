...
- Does not generate photographic, illustrated, or AI-rendered finishes. That is [[SOP-017-generate-a-styled-image]] (Pixel's skill). When a deliverable needs both layout and stylization, run this SOP first, then hand off to [[SOP-017-generate-a-styled-image]].
- Does not author the design system itself. That is Iris's territory in [[SOP-014-author-a-design-system]].
...
1. Route to Iris first (run [[SOP-014-author-a-design-system]] for the missing section). Preferred for any non-trivial creative work.
...
If the deliverable was structurally complete but needs photographic, illustrated, or AI-generated finishing on top of the layout, hand off to Pixel via [[SOP-017-generate-a-styled-image]]. Pixel takes the rendered HTML or PNG as a structural reference and produces the stylized final.
