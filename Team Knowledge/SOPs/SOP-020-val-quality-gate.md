...
- [ ] Session-log entry written at `Team Knowledge/session-logs/YYYY/MM/YYYY-MM-DD-HH-MM_val_<slug>.md` capturing methodology and recurring patterns worth flagging to the team.
