...
- Does not produce visual deliverables (slides, images, infographics). That is [[SOP-016-build-an-infographic]] and [[SOP-017-generate-a-styled-image]].
- Does not audit existing deliverables against GL-003. That is [[SOP-015-audit-content-for-design-system-compliance]].
