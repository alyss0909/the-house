...
- **`PKM/Second Brain/analysis/voice-archive.md`** — full 100-question archive with evidence, sources, and confidence ratings (HIGH/MED/LOW)
...
1. Update `voice-archive.md` with your answers (replacing LOW/MED with your actual words)
