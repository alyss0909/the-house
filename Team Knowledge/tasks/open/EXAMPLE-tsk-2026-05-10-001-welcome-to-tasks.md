...
linked_sops: [SOP-004-create-task, SOP-005-claim-task, SOP-006-close-task, SOP-008-rebuild-task-index]
linked_workstreams: []
...
- Procedure for creating tasks: [[SOP-004-create-task]]
- Procedure for claiming this: [[SOP-005-claim-task]]
- Procedure for closing this: [[SOP-006-close-task]]
- Procedure for keeping the index fresh: [[SOP-008-rebuild-task-index]]
...
- You read [[SOP-004-create-task]] and [[SOP-006-close-task]] to see the lifecycle.
- You close this task via [[SOP-006-close-task]] (which moves it to `done/2026/05/` and writes an outcome).
...
## Outcome
_(filled when you close this — see [[SOP-006-close-task]])_
