...
- Requires myPKA scaffold v1.7.0 or later (the version that introduced the Expansion system).
- Requires the core team agents Larry and Nolan — these are part of the v1.5+ scaffold and should already be in your team.
