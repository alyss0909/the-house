...
|---|---|---|
| "I don't know what ponytail means" | Fresh agent instance never read this SOP or GL-008 | Check `Team Knowledge/SOPs/INDEX.md` per the Internal Skills rule in root [[AGENTS]] before assuming a capability doesn't exist. |
