...
- **myPKA-facing procedure:** `Team Knowledge/SOPs/SOP-031-watch-video.md` (installed copy) — a pointer wrapper. Read `lib/SKILL.md` for the full, actively-maintained flag/detail-mode reference before the first `/watch`-equivalent call of a session.
