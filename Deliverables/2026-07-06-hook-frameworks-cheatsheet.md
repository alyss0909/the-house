---
title: Hook Frameworks Cheat Sheet — Reader-First Rebuild
date: 2026-07-06
station: hook-specialist
status: standing Test Kitchen input
---
...
**Definition:** Names the exact reader as a label she either claims or wants to claim, doing the "you" work through identity instead of direct address. Her existing Audience Identity formula, sharpened: the label itself must imply a stake, not just describe a demographic.
...
## 2. Felt-Stakes Threat

**Definition:** States the reader's specific, observable fear as flat fact — no listicle countdown, no second person needed, because the fear is described precisely enough that the reader locates herself in it automatically.
...
## 3. First-Person Mirror (confession / proxy / displaced)

**Definition:** A specific, slightly embarrassing first-person (or deliberately displaced third-person) admission the target reader recognizes as her own behavior — recognition does the pulling, not cleverness. Variants: straight first-person ("My List Has Forgotten Me Twice"), or third-person-displaced when the deck's own structure escalates toward a first-person landing (Pitch 5's portrait gallery).
...
## 4. The Receipt (reader-facing)

**Definition:** A real, odd (never rounded) number used as a stat the READER measures her own situation against, not a stat proving the writer's credibility. The number does the "you" work — she does the math on herself in the same second she reads it.
...
## 5. Escalating-Specificity Identity Mirror
...
## 6. Paradox, reader-proxy / format-native variant

**Definition:** Her existing Paradox formula (taboo behavior + legitimizing observation, period close, never a reframe), re-aimed so the "behavior" belongs to a stand-in for the reader (a client, a customer) rather than the writer, keeping the observation inside the visual metaphor itself.
...
## 7. Unfinished Business Callout (RULE-BEND family — never a default choice)

**Definition:** Names the reader's specific stalled action directly, using "you." This is the one framework whose strongest version genuinely requires second person — the sting comes from being addressed, not mirrored. Per instruction, included as max 1 flagged option per hook menu, never silently, never as the ranked favorite by default.
...
## 8. The First-3-Words Triage (process filter, not a hook shape)

**Definition:** Isolate the first 3 words of any candidate hook and ask whether they alone create curiosity, alarm, or a claim — independent of the rest of the sentence. Applied to every hook above before ranking.
...
## Current external-reference corroboration (2026)

Two 2026 sources checked for convergence with the frameworks above:

- Instagram carousel strategy analysis (2026) confirms the "BOLD HOOK HEADLINE + CURIOSITY TRIGGER" structure and that specificity ("2,400 followers in 30 days") outperforms cleverness ("how to grow fast") — directly supports the Receipt and Felt-Stakes frameworks' preference for real numbers/timestamps over abstract claims. [Instagram Carousel Strategy 2026](https://www.truefuturemedia.com/articles/instagram-carousel-strategy-2026)
- General 2026 hook-writing guidance confirms that naming a reader group directly by their own self-description terminology (Identity Callout's core mechanic) out-performs generic address, and reinforces the curiosity-gap principle used in the Escalating-Specificity Identity Mirror framework. [Marketing Hooks Explained](https://tlinky.com/marketing-hooks/)

Recurring principles extracted across both: reader-stakes-first over concept-cleverness, specificity over cleverness, curiosity-gap through withheld resolution (never a same-breath reframe), and identity-labeling as the primary non-"you" route to direct address — all already compatible with, and now folded into, the frameworks above.
