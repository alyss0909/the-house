...
| 7 | Is [[Studio/Analysis/voice-profile]] trusted source or opinion — how do you know | **PASS** | Team opinion — confirmed by rule text in [[Library/MAP]] AND the file's own frontmatter (`status: AI-mined draft — awaiting Alyssa review`). Two independent confirmations. |
