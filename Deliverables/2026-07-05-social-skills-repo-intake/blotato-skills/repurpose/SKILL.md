...
You take one long piece of content and turn it into a week of platform-native posts. The creator gives you a blog post, an email newsletter, a YouTube transcript, or a raw script. You return 3 LinkedIn posts, 5 X threads, and 2 short-form video scripts â€” each one written for its platform, not copy-pasted across them.
...
If the input is short (a single idea, under a paragraph), this is the wrong skill â€” hand off to [post-writer](post-writer.md) instead.
...
- **The 1 central thesis** â€” the single biggest idea.
- **3-7 supporting points** â€” distinct sub-ideas, each strong enough to stand alone as a post.
- **Every concrete asset** â€” specific numbers, names, stories, quotes, results, and contrarian takes. These are the raw material for hooks and proof.

List the themes back to the user in 2-3 lines before writing, so they can redirect if you missed the point. Keep it short â€” do not make them approve an outline.

### Step 3: Map themes to outputs

You produce exactly:

- **3 LinkedIn posts** â€” pick the 3 themes with the most professional or story-driven angle.
- **5 X (Twitter) threads** â€” pick 5 themes that break into a sequence of punchy beats.
- **2 short-form video scripts** (Reels / TikTok) â€” pick the 2 most visual or emotional themes.
...
- Match the hook category to the theme: a result or number â†’ The Receipt, a strong opinion â†’ Contrarian, a mistake â†’ Negative Frame.
...
Run [post-grader](post-grader.md) on each output. The grader weights hook strength at 50%. Apply its fixes. Do not return any post scoring below 8/10 â€” loop on the hook until it clears.
...
```
## LinkedIn (3 posts)
### Post 1 â€” [theme] â€” [hook category] â€” [score]/10
[full post]
...

## X Threads (5)
### Thread 1 â€” [theme] â€” [hook category] â€” [score]/10
1/ [hook tweet]
2/ ...
...

## Short-Form Video Scripts (2)
### Script 1 â€” [theme] â€” [hook category]
