...
- Customer story â†’ Vulnerable Story Hook (#5)
- Strong opinion / wedge â†’ Reverse Hook (#10) or Reframe (#1)
- Numbers / data / case study â†’ Receipts Hook (#9) or Specific Number Hook (#3)
- Industry critique â†’ Reframe (#1), Contrarian Take (#6), or Reverse Hook (#10)
- Tip / how-to â†’ Stolen Lesson Hook (#11) or Pain Point List (#7)
- Recognition / "you do this" â†’ Pain Point List (#7) or Vulnerable Story (#5)

When in doubt, prefer #9, #10, or #11 â€” they have the highest virality ceiling.
...
3. Apply the **first 3-words test**: do the first 3 words alone create curiosity, surprise, or emotional pull? "Here's what I" â€” fail. "I tested 47" â€” pass. "Most people think" â€” pass.
...
- **Specificity**: Use real numbers, real names, real situations. Not "many customers" â€” "the customer who emailed me Tuesday."
- **One idea**: One concrete insight per post. If it's two ideas, save the second for another post.
- **You/your**: Address the reader directly. Not "people who run small businesses" â€” "you, running your business."
...
**Weak CTAs to avoid:**
- "What do you think?" (too vague â€” produces nothing)
...
- [ ] No "really," "very," "just," "literally," "actually," "basically" â€” these are filler
