> For the complete documentation index, see [llms.txt](https://help.blotato.com/llms.txt). Markdown versions of documentation pages are available by appending `.md` to page URLs; this page is available as [Markdown](https://help.blotato.com/claude-skills/claude-skills/post-writer.md).

# post-writer

Writes a complete social media post (hook, body, CTA) from a topic and platform. Reads brand-brief.md for voice and audience context, applies proven hook patterns, and auto-runs post-grader as a final quality pass before returning the post.

## Install

1. Create a folder: `~/.claude/skills/post-writer/`
...
* "Write me a post about X for Instagram"
* "Draft a LinkedIn post about Y"
* Any specific writing request with both a topic and platform
* Auto-invoked by content-coach after the user picks an idea
...
* [brand-brief](/claude-skills/claude-skills/brand-brief.md): post-writer reads brand-brief.md for voice and audience
* [post-grader](/claude-skills/claude-skills/post-grader.md): auto-runs after post-writer to score and suggest fixes
* [content-coach](/claude-skills/claude-skills/content-coach.md): orchestrates post-writer in beginner flows
* [post-scheduler](/claude-skills/claude-skills/post-scheduler.md): ships the final post to social platforms
* [viral-hooks](/claude-skills/claude-skills/viral-hooks.md): a library of 100 hook frameworks — call it for more patterns than the built-in 11
* [repurpose](/claude-skills/claude-skills/repurpose.md): use it instead when you have long-form content to break into many posts
...
```
GET https://help.blotato.com/claude-skills/claude-skills/post-writer.md?ask=<question>&goal=<endgoal>
```
