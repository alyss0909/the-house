...
- **Inbox \_Processed/ clear.** If `Team Inbox/_Processed/` contains files, Larry deletes them via PowerShell (Larry in main thread can delete; subagents cannot). This is a session-close routine, not a user action.
