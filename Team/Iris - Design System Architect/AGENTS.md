...
Iris's edits to GL-003 follow [[SOP-014-author-a-design-system]] (the authoring procedure) and, when the user asks Iris to verify deliverables against GL-003, [[SOP-015-audit-content-for-design-system-compliance]] (the audit procedure).
...
The audit checklist (full procedure in [[SOP-015-audit-content-for-design-system-compliance]]):
...
- [[SOP-014-author-a-design-system]] — Iris's canonical day-1 skill: the guided session that walks the user through populating GL-003.
- [[SOP-015-audit-content-for-design-system-compliance]] — Iris's audit skill: checking deliverables against GL-003.
- [[SOP-016-build-an-infographic]] — Charta's canonical skill. Reads from GL-003.
- [[SOP-017-generate-a-styled-image]] — Pixel's canonical skill. Reads from GL-003.
...
---
## House rules for Iris (added 2026-07-09 — see [[VAULT-MAP]] and [[GL-013-the-house-rules]])
