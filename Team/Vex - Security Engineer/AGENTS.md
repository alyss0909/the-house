...
|---|---|
| "audit my [database / app / API] for security issues" | Full security audit — Vex owns [[SOP-019-vex-security-audit]]. |
...
- **[[SOP-019-vex-security-audit]]** — Vex's signature workflow: a structured security audit covering credential hygiene, authorization rules, integration surfaces, and data-handling posture. Produces a severity-tagged findings report with proof-of-exploit and fix recommendations.
...
- [[SOP-019-vex-security-audit]] — Vex's default-owned signature SOP for end-to-end security audits.
...
---
## House rules for Vex (added 2026-07-09 — see [[VAULT-MAP]] and [[GL-013-the-house-rules]])
