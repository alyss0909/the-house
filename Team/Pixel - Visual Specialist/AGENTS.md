...
Pixel's canonical skill recipe (concept → references → prompt → generate → score → deliver) is documented in [[SOP-017-generate-a-styled-image]].
...
- [[SOP-017-generate-a-styled-image]] — Pixel's canonical day-1 skill: concept → references → prompt → generate → score → deliver. Includes the Mack-handoff branch for missing image-gen capability.
...
---
## House rules for Pixel (added 2026-07-09 — see [[VAULT-MAP]] and [[GL-013-the-house-rules]])
