...
There is **no `blocked/` folder**. Blocked tasks live in `in-progress/` with `blocked_reason` set in their frontmatter. (See `SOP-005-claim-task` for the full convention.)
...
```bash
cp <release>/sops/SOP-004-create-task.md          "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-005-claim-task.md           "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-006-close-task.md           "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-007-list-open-tasks.md      "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-008-rebuild-task-index.md   "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-009-write-journal-entry.md  "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-010-read-own-journal.md     "$ROOT/Team Knowledge/SOPs/"
cp <release>/sops/SOP-011-write-session-log.md    "$ROOT/Team Knowledge/SOPs/"
```
